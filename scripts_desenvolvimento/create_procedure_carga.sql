-- PRIMEIRO PROCEDIMENTO: CRIAÇÃO DO BANCO E DO PROCEDIMENTO DE CARGA

CREATE DATABASE IF NOT EXISTS BazarDB;
USE BazarDB;

DROP PROCEDURE IF EXISTS sp_CreateTableCarga;

DELIMITER //

CREATE PROCEDURE sp_CreateTableCarga()
BEGIN	
    
    -- FAZ A OPERAÇÃO DE RESET (FUNCIONA COMO TABELA TEMPORÁRIA)
